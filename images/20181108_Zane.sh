...
CONDA_PKGS='freebayes gatk snpeff platypus-variant'
...
CONDA_PKGS_DEF='sambamba samtools igv bedtools fastqc picard bcftools vcftools'
# make base
...
# Installing sublime
echo -e "* Installing sublime *" >>$_logfile
...
pkgs <- c("tidyverse", "ggrepel", "AnnotationHub", "biomaRt", "Biostrings", "BSgenome",
          "DESeq2", "GenomicRanges", "GenomicFeatures", "Rsamtools", "rtracklayer",
          "Gviz", "Biobase", "edgeR", "limma", "Glimma", "xtable", "pander", "knitr",
          "rmarkdown", "scales", "corrplot", "pheatmap", "devtools",
          "BiocGenerics", "BiocStyle", "checkmate", "ggdendro", "SeqArray",, "gdsfmt",
...
# This seems to fix some of the issues with installing Jupyter/R
