...
CONDA_PKGS='adapterremoval2 kallisto'
...
CONDA_PKGS_DEF='sambamba star samtools subread igv bedtools fastqc picard'
# make base
...
pkgs <- c("tidyverse", "ggrepel", "AnnotationHub", "biomaRt", "Biostrings", "BSgenome",
          ...
          "BiocGenerics", "BiocStyle", "checkmate", "ggdendro", 
          "plotly", "shiny", "ShortRead", "viridis", "viridisLite", "zoo", "shinyFiles",
          "ngsReports", "strandCheckR")
