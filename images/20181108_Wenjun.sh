...
CONDA_PKGS='adapterremoval2 kallisto subread'
...
CONDA_PKGS_DEF='sambamba star hisat2 samtools subread igv bedtools fastqc picard'
# make base
...
pkgs <- c("tidyverse", "ggrepel", "AnnotationHub", "biomaRt", "Biostrings", "BSgenome",
          ...
          "BiocGenerics", "BiocStyle", "checkmate", "ggdendro", "sleuth", 
